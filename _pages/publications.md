...
This page highlights selected publications and accepted papers. For the most complete and current list, see [Google Scholar](https://scholar.google.com/citations?user=D6dipYIAAAAJ&hl=en).
...
- **Ding, L.**, Hu, Y., Denier, N., Shi, E., Zhang, J., Hu, Q., Hughes, K. D., Kong, L., and Jiang, B. [**Probing Social Bias in Labor Market Text Generation by ChatGPT: A Masked Language Model Approach.**](https://proceedings.neurips.cc/paper_files/paper/2024/file/fce2d8a485746f76aac7b5650db2679d-Paper-Conference.pdf) *Advances in Neural Information Processing Systems*.
- [**Language in Job Advertisements and the Reproduction of Labor Force Gender and Racial Segregation.**](https://academic.oup.com/pnasnexus/article/3/12/pgae526/7905141?login=false) *PNAS Nexus*.
- Shen, K., **Ding, L.**, Kong, L., and Liu, X. [**From Physical Space to Cyberspace: Recessive Gender Biases in Social Media Mirror the Real World.**](https://www.sciencedirect.com/science/article/abs/pii/S0264275124003639) *Cities*, 152, 105149.
- Shi, E., **Ding, L.**, Kong, L., and Jiang, B. [**Debiasing with Sufficient Projection: A General Theoretical Framework for Vector Representations.**](https://aclanthology.org/2024.naacl-long.332.pdf) *NAACL 2024*, 5960–5975.

## 2023

- Jiang, Y., Chang, X., Liu, Y., **Ding, L.**, Kong, L., and Jiang, B. [**Gaussian Differential Privacy on Riemannian Manifolds.**](https://proceedings.neurips.cc/paper_files/paper/2023/hash/2f27964513a28d034530bfdd117ea31d-Abstract-Conference.html) *NeurIPS 2023*, 14665–14684.
- Liu, Y., Hu, Q., **Ding, L.**, and Kong, L. [**Online Local Differential Private Quantile Inference via Self-normalization.**](https://proceedings.mlr.press/v202/liu23q.html) *ICML 2023*, 21698–21714.
- Mosquera, L., El Emam, K., **Ding, L.**, Sharma, V., Zhang, X. H., Kababji, S. E., et al. [**A Method for Generating Synthetic Longitudinal Health Data.**](https://link.springer.com/article/10.1186/s12874-023-01869-w) *BMC Medical Research Methodology*, 23(1), 1–21.

## 2022 and earlier

- **Ding, L.**, Yu, D., Xie, J., Guo, W., Hu, S., Liu, M., Kong, L., Dai, H., Bao, Y., and Jiang, B. [**Word Embeddings via Causal Inference: Gender Bias Reducing and Semantic Information Preserving.**](https://ojs.aaai.org/index.php/AAAI/article/view/21443) *AAAI 2022*, 11864–11872.
